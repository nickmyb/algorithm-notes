...
// 这个文件里的章节顺序表和目录标题映射只服务于上游 LeetCode-Go 的 Hugo 站点（website/）
// 与 PDF 电子书的章节结构，本仓库没有引入 website/，所以整个文件用 //go:build ignore 停用。
//
// 要恢复：补回 website/ 目录，然后删掉本文件第一行的 //go:build ignore。
// 相关的停用文件还有 ctl/render_website.go、ctl/pdf.go、ctl/util/website.go。
